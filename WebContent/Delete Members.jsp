...
//אם הכל תקין
alert("Member Deleted Succefully");
...
%>
	<p style="Calibri">
		<br/><br/><br/><br/><br/><br/>
		<h2 align="center"> <font color="white" size="15"><b>Delete Members:</b></font></h2>
		<hr color="white" width="200"><br/>
<p align="center">		
<form action="Delete Members.jsp" method="post">

	<input type="text" placeholder="Username" name="user" >  
	<input type="password" placeholder="Password" name="password">
    <input type="submit" placeholder="submit" name="submit" value="Delete Member">  
...
<%
  ...
  {	  
         ...
         String user=request.getParameter("user");
          ...
          ClimateChange.insertUpdateDelete("delete from ClimateChange where Password='"+pass+"'" + "and Name='"+user+"'");}
