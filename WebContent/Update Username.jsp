...
%>	
	<p style="Calibri">
		<br/><br/><br/><br/><br/><br/>
		<h2 align="center"> <font color="white" size="15"><b>Change Username:</b></font></h2>
		<hr color="white" width="200"><br/>
<p align="center">		
<form action="Update Username.jsp" method="post">

	<input type="text" placeholder="Username" name="userChange" >  
	<input type="text" placeholder="Confirm Username" name="user2">
    <input type="submit" placeholder="submit" name="submit" value="Change Username">  
...
<%
  ...
  {	  
	  	String user2=request.getParameter("userChange");
	  	 System.out.println("update ClimateChange set Name= '"+user2+"' where Name='"+session.getAttribute("user")+"'");
	     ClimateChange.insertUpdateDelete("update ClimateChange set Name= '"+user2+"' where Name='"+session.getAttribute("user")+"'");
